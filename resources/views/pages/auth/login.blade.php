            ...
            <div class="row d-flex">
                <div class="col-lg-6">
                    <div class="card1 pb-5">
                        <div class="row"> <img src="{{ asset('assets/dist/img/logo-swimoc.png') }}" class="logo">
                        </div>
                        <div class="row px-3 justify-content-center mt-4 mb-5 border-line"> <img
                                src="{{ asset('assets/dist/img/login.svg') }}" class="image"> </div>
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="card2 card border-0 px-4 py-5">
                        ...
                        <form action="{{ route('aksilogin') }}" method="POST">
                            ...
                            <div class="row px-3"> <label class="mb-1">
                                <h6 class="mb-0 text-sm">Level</h6>
                                <select name="level" class="form-control mb-4" style="width: 100%">
                        ...
                        <div class="row mb-4 px-3"> <small class="font-weight-bold">Don't have an account? <a
                                    href="{{ route('register') }}" class="text-danger ">Register</a></small> </div>
                    </div>
                </div>
            </div>
