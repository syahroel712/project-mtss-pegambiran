                        ...
                        <div class="col-12">
                            ...
                            <div class="card">
                                <div class="card-header">
                                    ...
                                    <h3 class="card-title"><a class="btn btn-primary btn-sm text-white" href="{{ route('guru.create') }}"><i class="fa fa-plus"></i> Add</a></h3>
                                    @endif
                                    ...
                                    <table id="example1" class="table table-bordered table-striped example1">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>{{ $gr->guru_nip }}</td>
                                                <td>{{ $gr->guru_nama }}</td>
                                                <td>{{ \Carbon\Carbon::parse($gr->guru_tgl_lahir)->isoFormat('D MMMM Y') }}</td>
                                                <td>{{ $gr->guru_notelp }}</td>
                                                ...
                                                <td>
                                                    ...
                                                    <button type="button" class="btn btn-danger btn-sm" onclick="mHapus('{{ route('guru.delete', $gr->guru_id) }}')"><i class="fa fa-trash"></i> </button>
                                                </td>
                                                @endif
                                            </tr>
                                            @endforeach
