                        ...
                        <div class="col-12">
                            ...
                            <div class="card">
                                <div class="card-header">
                                    <!-- <h3 class="card-title"><a class="btn btn-primary btn-sm text-white" href="{{ route('kepsek.create') }}"><i class="fa fa-plus"></i> Add</a></h3> -->
                                ...
                                <div class="card-body">
                                    ...
                                    <table id="example1" class="table table-bordered table-striped example1">
                                        ...
                                        <tbody>
                                            @foreach($kepsek as $no => $kps)
                                            <tr>
                                                <td>{{ $no+1 }}</td>
                                                <td>{{ $kps->guru_nip }}</td>
                                                <td>{{ $kps->guru_nama }}</td>
                                                <td>{{ $kps->kepsek_tahun }}</td>
                                                @if(session()->get('user_jabatan') == 'Admin')
                                                <td>
                                                    <a href="{{ route('guru.edit', $kps->guru_id) }}" class="btn btn-warning btn-sm"><i class="fa fa-edit"></i></a>
                                                </td>
                                                @endif
                                            </tr>
                                            @endforeach
